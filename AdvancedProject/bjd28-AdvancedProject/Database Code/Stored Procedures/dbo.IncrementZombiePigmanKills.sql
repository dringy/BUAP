CREATE PROCEDURE [dbo].[IncrementZombiePigmanKills]
...
AS
	...
	Update PlayerMapStats set ZombiePigmanKills = ZombiePigmanKills + 1 where PlayerID = @PlayerID AND MapID = @MapID
RETURN 0